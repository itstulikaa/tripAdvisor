...
#url = ("https://www.tripadvisor.in/Hotels-g303251-State_of_Bahia-Hotels.html")
#url = ("https://www.tripadvisor.com/Hotels-g147319-Puerto_Rico-Hotels.html")
#url = ("https://www.tripadvisor.com/Hotels-g147414-Bahamas-Hotels.html")
#url = ("https://www.tripadvisor.com/Hotels-g1575485-Quintana_Roo_Yucatan_Peninsula-Hotels.html")
#url = ("https://www.tripadvisor.com/Hotels-g147288-Dominican_Republic-Hotels.html")
...
driver = webdriver.Chrome('C:/Users/Loginworks/Desktop/python/chromedriver.exe')
...
def Extract():
    ...
    append_list_as_row('Hotels_output_Quintana_Roo.csv', row_contents)
...
Next_button_1 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[2]")
Next_button_1.click()
time.sleep(10)
Name_fun()
...
Next_button_2 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[3]")
Next_button_2.click()
time.sleep(10)
Name_fun()


Next_button_3 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[4]")
Next_button_3.click()
time.sleep(10)
Name_fun()
...
Next_button_4 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[5]")
Next_button_4.click()
time.sleep(10)
Name_fun()
...
Next_button_5 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[6]")
Next_button_5.click()
time.sleep(10)
Name_fun()
...
Next_button_6 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[7]")
Next_button_6.click()
time.sleep(10)
Name_fun()
...
Next_button_7 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[8]")
Next_button_7.click()
time.sleep(10)
Name_fun()
...
Next_button_8 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[9]")
Next_button_8.click()
time.sleep(10)
Name_fun()
...
Next_button_9 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[10]")
Next_button_9.click()
time.sleep(10)
Name_fun()
...
Next_button_10 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[11]")
Next_button_10.click()
time.sleep(10)
Name_fun()



Next_button_11 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[12]")
Next_button_11.click()
time.sleep(10)
Name_fun()



Next_button_12 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[13]")
Next_button_12.click()
time.sleep(10)
Name_fun()



Next_button_13 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[14]")
Next_button_13.click()
time.sleep(10)
Name_fun()



Next_button_14 = driver.find_element_by_xpath("(//div[contains(@class,'pageNumbers')]//span)[15]")
Next_button_14.click()
time.sleep(10)
Name_fun()
